...
The screenshots of the app and how it functions are located in the Bamazon github project folder. The files can be viewed either by opening the three individual jpeg files: screenshot1.jpg, screenshot2.jpg and screenshot3.jpg or by viewing all three pages contained in the Acrobat file titled Screenshot.pdf.
